...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    # initialize thea closedList [list that contains the expanded/visited nodes (states)]
    closedList = []
    ...
    while not problem.isGoalState(currentState):
        ...
        for successor in successors:
            ...
            for (visitedState, visitedToCost) in closedList:
                # if the successor has already been visited and still has a new cost greater
                # then the previous one, check isStateVisited as true
        ...
        # get the new current State which will be the state with smaller total cost
        (currentState, toCurrentStateDirection,
